document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // Dispatch custom event for form submission handling
      ...
      // Default success behavior if no custom handler prevents it
      setTimeout(function () {
  ...
  // ─── Auto-detect and animate generic sections as fade-in ─────────────────────
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "חורזים חרוזים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '5f2aa3c2-0ab1-407d-bd8f-9c23aae976d7',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '5f2aa3c2-0ab1-407d-bd8f-9c23aae976d7';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5f2aa3c2-0ab1-407d-bd8f-9c23aae976d7';
